...
INSERT INTO TICKET1(TICKET_NUMBER, SOURCE, DESTINATION, DATE_OF_BOOKING, DATE_OF_CANCELLATION, DATE_OF_TRAVEL, CLASS, PID, PASSPORTNO)
VALUES(0011234111122,'BOM','DFW','2016-05-11',NULL,'2016-12-15','ECONOMY',1,'A1234568');

INSERT INTO TICKET1(TICKET_NUMBER, SOURCE, DESTINATION, DATE_OF_BOOKING, DATE_OF_CANCELLATION, DATE_OF_TRAVEL, CLASS, PID, PASSPORTNO)
VALUES(0984567222299,'JFK','BOM','2016-06-11','2016-12-10','2016-12-20','ECONOMY',2,'B9876541');

INSERT INTO TICKET1(TICKET_NUMBER, SOURCE, DESTINATION, DATE_OF_BOOKING, DATE_OF_CANCELLATION, DATE_OF_TRAVEL, CLASS, PID, PASSPORTNO)
VALUES(1768901333273,'IAH','DEL','2016-08-21',NULL,'2016-12-25','BUSINESS',3,'C2345698');

INSERT INTO TICKET1(TICKET_NUMBER, SOURCE, DESTINATION, DATE_OF_BOOKING, DATE_OF_CANCELLATION, DATE_OF_TRAVEL, CLASS, PID, PASSPORTNO)
VALUES(5890987441464,'IXC','IAH','2016-08-10',NULL,'2017-01-12','FIRST-CLASS',4,'D1002004');

INSERT INTO TICKET1(TICKET_NUMBER, SOURCE, DESTINATION, DATE_OF_BOOKING, DATE_OF_CANCELLATION, DATE_OF_TRAVEL, CLASS, PID, PASSPORTNO)
VALUES(1577654664266,'JFK','TPA','2016-06-13',NULL,'2016-12-10','ECONOMY',5,'X9324666');

INSERT INTO TICKET1(TICKET_NUMBER, SOURCE, DESTINATION, DATE_OF_BOOKING, DATE_OF_CANCELLATION, DATE_OF_TRAVEL, CLASS, PID, PASSPORTNO)
VALUES(2206543545545,'BOM','DFW','2016-11-11',NULL,'2016-02-12','ECONOMY',6,'B8765430');

INSERT INTO TICKET1(TICKET_NUMBER, SOURCE, DESTINATION, DATE_OF_BOOKING, DATE_OF_CANCELLATION, DATE_OF_TRAVEL, CLASS, PID, PASSPORTNO)
VALUES(7064321779737,'IAH','DEL','2016-11-15',NULL,'2016-12-25','FIRST-CLASS',7,'J9801235');

INSERT INTO TICKET1(TICKET_NUMBER, SOURCE, DESTINATION, DATE_OF_BOOKING, DATE_OF_CANCELLATION, DATE_OF_TRAVEL, CLASS, PID, PASSPORTNO)
VALUES(1571357215116,'SFO','FRA','2016-10-15',NULL,'2016-12-18','ECONOMY',8,'A1122334');

INSERT INTO TICKET1(TICKET_NUMBER, SOURCE, DESTINATION, DATE_OF_BOOKING, DATE_OF_CANCELLATION, DATE_OF_TRAVEL, CLASS, PID, PASSPORTNO)
VALUES(1570864987655,'IXC','IAH','2016-11-12',NULL,'2016-12-30','ECONOMY',9,'Q1243567');

INSERT INTO TICKET1(TICKET_NUMBER, SOURCE, DESTINATION, DATE_OF_BOOKING, DATE_OF_CANCELLATION, DATE_OF_TRAVEL, CLASS, PID, PASSPORTNO)
VALUES(1579283997799,'BOM','SFO','2016-01-22',NULL,'2016-12-15','ECONOMY',10,'S1243269');

INSERT INTO TICKET1(TICKET_NUMBER, SOURCE, DESTINATION, DATE_OF_BOOKING, DATE_OF_CANCELLATION, DATE_OF_TRAVEL, CLASS, PID, PASSPORTNO)
VALUES(1255701876107,'FRA','DEL','2016-10-19',NULL,'2016-12-31','ECONOMY',11,'E3277889');

INSERT INTO TICKET1(TICKET_NUMBER, SOURCE, DESTINATION, DATE_OF_BOOKING, DATE_OF_CANCELLATION, DATE_OF_TRAVEL, CLASS, PID, PASSPORTNO)
VALUES(1251334499699,'IXC','IAH','2016-11-20',NULL,'2017-01-12','ECONOMY',12,'K3212322');

INSERT INTO TICKET1(TICKET_NUMBER, SOURCE, DESTINATION, DATE_OF_BOOKING, DATE_OF_CANCELLATION, DATE_OF_TRAVEL, CLASS, PID, PASSPORTNO)
VALUES(1258776199490,'BOM','DFW','2016-05-13','2016-05-25','2016-12-15','ECONOMY',13,'P3452390');

INSERT INTO TICKET1(TICKET_NUMBER, SOURCE, DESTINATION, DATE_OF_BOOKING, DATE_OF_CANCELLATION, DATE_OF_TRAVEL, CLASS, PID, PASSPORTNO)
VALUES(5891155114477,'FRA','DEL','2016-06-26',NULL,'2016-12-23','ECONOMY',14,'W7543336');

INSERT INTO TICKET1(TICKET_NUMBER, SOURCE, DESTINATION, DATE_OF_BOOKING, DATE_OF_CANCELLATION, DATE_OF_TRAVEL, CLASS, PID, PASSPORTNO)
VALUES(5893069766787,'BOM','DFW','2016-08-11',NULL,'2016-12-22','ECONOMY',15,'R8990566');
...
INSERT INTO TICKET2(DATE_OF_BOOKING, SOURCE, DESTINATION, CLASS, PRICE) 
VALUES('2016-08-13','JFK','TPA','ECONOMY',98000);
...
INSERT INTO TICKET2(DATE_OF_BOOKING, SOURCE, DESTINATION, CLASS, PRICE) 
VALUES('2016-08-15','SFO','FRA','ECONOMY',170000);
...
INSERT INTO TICKET2(DATE_OF_BOOKING, SOURCE, DESTINATION, CLASS, PRICE) 
VALUES('2016-08-19','FRA','DEL','ECONOMY',100000);
